package com.min.projectboard.util;
...
class FormDataEncoderTest {
    ...
    class TestObject{
        ...
        public TestObject(String str, String listStr1, String listStr2,
                          String nullStr, Integer number, Double floatingNumber,
                          Boolean bool, BigDecimal bigDecimal, TestEnum testEnum) {
            this.str = str;
