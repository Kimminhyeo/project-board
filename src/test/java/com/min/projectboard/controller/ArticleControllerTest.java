...
import com.min.projectboard.config.SecurityConfig;
import com.min.projectboard.config.TestSecurityConfig;
import com.min.projectboard.domain.constant.FormStatus;
import com.min.projectboard.domain.constant.SearchType;
...
import com.min.projectboard.dto.request.ArticleRequest;
import com.min.projectboard.dto.response.ArticleResponse;
import com.min.projectboard.service.ArticleService;
import com.min.projectboard.service.PaginationService;
import com.min.projectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    public void givenPagingAndSortingParams_whenSearchingArticlesPage_thenReturnsArticlesPage() throws Exception {
        ...
        mvc.perform(
                ...
                .andExpect(view().name("articles/index"))
                .andExpect(model().attributeExists("articles"))
                .andExpect(model().attribute("paginationBarNumbers", pageable.getPageNumber()));
    ...
    @WithUserDetails(value = "userTest", userDetailsServiceBeanName = "userDetailsService", setupBefore = TestExecutionEvent.TEST_EXECUTION)
