package com.min.projectboard.dto.security;
...
@Getter
@SuppressWarnings("unchecked")  // TODO: Map ->  TODO: Map -> Object 변환 로직이 있어 제네릭 타입 캐스팅 문제를 무시한다. 더 좋은 방법이 있다면 고려할 수 있음.
public class KakaoOAuth2Response {
    ...
    public String email() { return this.kakaoAccount.getEmail(); }
...
class KakaoAccount{
    ...
    public KakaoAccount(Boolean profileNicknameNeedsAgreement,
                        Profile profile,
                        Boolean hasEmail,
                        Boolean emailNeedsAgreement,
                        Boolean isEmailValid,
    ...
    public String nickname() { return profile.getNickname(); }
}
